...
# Set religions to whatever the solr instance name is
solr = pysolr.Solr('http://localhost:8983/solr/religions/', always_commit=True)
...
def get_query():
    ...
    if clustering_method != 'none':
        result = get_clustering_results(api_resp, clustering_method)
