...
hub_score_file = open("c:/Users/Jinal/Desktop/UniEngine/HITS/precomputed_scores/hubs_score_1", 'w')
authority_score_file = open("c:/Users/Jinal/Desktop/UniEngine/HITS/precomputed_scores/authority_score_1", 'w')
...
def get_webgraph_inlinks():
    inlinks_file = open("C:/Users/Jinal/Downloads/apache-nutch-1.18-bin/apache-nutch-1.18/inlinkdb/part-r-00000", 'r', encoding="utf-8").readlines()
